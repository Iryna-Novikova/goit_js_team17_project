...
async function loadFeedbacks() {
    try {
        console.log('Fetching feedbacks from:', 'https://sound-wave.b.goit.study/api/feedbacks');
        const data = await getFeedback(1, 3); // Виклик нової функції
        const feedbacks = data.data; // Адаптація до структури вашого API
